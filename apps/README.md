...
[ADR 0350](../docs/adr/0350-mecatl-studio-in-repo-web-ui.md); the acceptance contract is
...
(ADR 0350, decision 5). `.env.example` lists them with comments; `pnpm dev` reads `../.env`
