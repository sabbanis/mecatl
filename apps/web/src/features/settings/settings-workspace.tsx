...
const supportUrl = "https://github.com/stacklok/mecatl-studio/issues";

/**
 * Grouped to match Studio's Settings sidebar (Preferences / Agent runtime /
 * Support section headers) — this product implements one section per
 * Studio group it has data for; groups with no backed section
 * (Experimental, and the Permissions/MCP tools rows under Agent runtime —
 * both controller-sidecar-owned, see the PR notes) are omitted rather than
 * faked.
 */
  ...
  return (
    <Section icon={Server} title="Providers">
      <p className="text-sm text-muted-foreground">
        Provider setup is managed by your organization. Credentials are never shown here.
      </p>
