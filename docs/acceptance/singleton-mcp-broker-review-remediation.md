...
**ADR:** [ADR 0328](../adr/0328-bounded-singleton-mcp-broker-correctness.md) — bounded receipts, admission, readiness, and deployment truth.
...
- [ADR 0328](../adr/0328-bounded-singleton-mcp-broker-correctness.md) keeps correctness process-local and bounded while closing ADR 0326's incomplete receipt contract.
- [ADR 0327](../adr/0327-single-replica-mcp-broker-topology.md) remains the one-replica `Recreate` topology; this work makes its readiness, drain, and deployment claims true.
...
remote-adapter contract in [ADR 0328](../adr/0328-bounded-singleton-mcp-broker-correctness.md)
...
and tightened by [ADR 0328](../adr/0328-bounded-singleton-mcp-broker-correctness.md).
...
is anchored by [ADR 0327](../adr/0327-single-replica-mcp-broker-topology.md) and the diagnostics
...
This makes the deployment consequences of [ADR 0327](../adr/0327-single-replica-mcp-broker-topology.md)
and [ADR 0328](../adr/0328-bounded-singleton-mcp-broker-correctness.md) executable.
...
|---|---|---|
| Cross-process durable Execute receipts or exactly-once upstream effects | distributed broker phase | [ADR 0328](../adr/0328-bounded-singleton-mcp-broker-correctness.md) explicitly bounds receipts to one incarnation |
| Interchangeable replicas, callback failover, and shared outer authority | distributed broker phase | [ADR 0327](../adr/0327-single-replica-mcp-broker-topology.md) remains single-replica `Recreate` |
