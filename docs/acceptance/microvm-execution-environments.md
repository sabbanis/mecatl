...
**ADR:** [ADR 0349](../adr/0349-microvm-execution-environments.md)
...
[ADR 0349 — readiness](../adr/0349-microvm-execution-environments.md#5-make-readiness-part-of-ordinary-use).
...
This follows [ADR 0349 — singleton lifecycle](../adr/0349-microvm-execution-environments.md#2-use-one-durable-vmrootfs-record-per-operator-and-canonical-git-repository).
...
This follows [ADR 0349 — direct Brood consumption](../adr/0349-microvm-execution-environments.md#4-consume-brood-directly-and-provide-an-explicit-linux-guest).
...
This follows [ADR 0349's Linux guest decision](../adr/0349-microvm-execution-environments.md#4-consume-brood-directly-and-provide-an-explicit-linux-guest).
