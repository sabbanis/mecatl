...
**ADR:** [ADR 0345](../adr/0345-microvm-execution-environments.md)
...
[ADR 0345 — readiness](../adr/0345-microvm-execution-environments.md#5-make-readiness-part-of-ordinary-use).
...
This follows [ADR 0345 — singleton lifecycle](../adr/0345-microvm-execution-environments.md#2-use-one-durable-vmrootfs-record-per-operator-and-canonical-git-repository).
...
This follows [ADR 0345 — direct Brood consumption](../adr/0345-microvm-execution-environments.md#4-consume-brood-directly-and-provide-an-explicit-linux-guest).
...
This follows [ADR 0345's Linux guest decision](../adr/0345-microvm-execution-environments.md#4-consume-brood-directly-and-provide-an-explicit-linux-guest).
