...
**ADR:** [ADR 0350](../adr/0350-microvm-execution-environments.md)
...
This follows [ADR 0350's Linux guest decision](../adr/0350-microvm-execution-environments.md#4-consume-brood-directly-and-provide-an-explicit-linux-guest).
