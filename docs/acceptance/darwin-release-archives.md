...
**ADR:** [ADR-0319](../adr/0319-signed-darwin-release-archives.md)
...
- **Security / authority:** None — no runtime security or authority interface changes; the workflow-only least-privilege and signing contract is pinned by ADR-0319 and the offline test.
