...
**ADR:** [ADR-0245](../adr/0245-session-scoped-vmcp-broker.md) — broker ownership, stable tool routing, and the control/data-plane boundary.
...
- **Stable configured tools, authorization at execution.** The model chooses an
  ...
  registration ([ADR-0245](../adr/0245-session-scoped-vmcp-broker.md)).
...
decision ([ADR-0245](../adr/0245-session-scoped-vmcp-broker.md)) and preserves
...
[ADR-0245](../adr/0245-session-scoped-vmcp-broker.md). Its operational messages
...
|---|---|---|
| Agent-loop parking and exact original-tool-call replay | Stage 3 conversation integration | [ADR-0245](../adr/0245-session-scoped-vmcp-broker.md) |
| Mecatui command and public control protocol | later UI/API slice | [ADR-0245](../adr/0245-session-scoped-vmcp-broker.md) |
| Second OAuth backend under one ToolHive auth session | ToolHive `ConnectUpstream` capability | [ADR-0245](../adr/0245-session-scoped-vmcp-broker.md) |
| Owner/principal matrix, delegation, and tenant authorization | later identity stage | [ADR-0245](../adr/0245-session-scoped-vmcp-broker.md) |
| Durable/multi-replica broker storage | later sidecar storage stage | [ADR-0245](../adr/0245-session-scoped-vmcp-broker.md) |
| Sidecar binary, Helm, Kind, ConfigMap mounting, RPC, and production sidecar authentication | deployment stage | [ADR-0245](../adr/0245-session-scoped-vmcp-broker.md) |
| Dynamic configuration or catalogue reload | later operations stage | [ADR-0245](../adr/0245-session-scoped-vmcp-broker.md) |
