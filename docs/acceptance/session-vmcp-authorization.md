...
**ADR:** [ADR-0246](../adr/0289-configured-resumable-mcp-authorization.md) — one MCP authority mode, durable authorizing state, and exact continuation; [ADR-0247](../adr/0290-broker-generic-oauth2-upstreams.md) — broker-only explicit generic OAuth2 upstreams; [ADR-0248](../adr/0291-bundled-mcp-workspace-enrollment.md) — pre-prompt bundled enrollment and authenticated frozen catalogues.
...
- [ADR-0245](../adr/0288-session-scoped-vmcp-broker.md) fixes the original Stage 2
...
([ADR-0248](../adr/0291-bundled-mcp-workspace-enrollment.md)).
...
([ADR-0245](../adr/0288-session-scoped-vmcp-broker.md)).
...
the continuation ([ADR-0246](../adr/0289-configured-resumable-mcp-authorization.md)).
...
|---|---|---|
| Durable/shared multi-replica broker transactions and credentials | distributed broker stage | [ADR-0246](../adr/0289-configured-resumable-mcp-authorization.md) |
| Remote sidecar broker protocol and authentication | deployment/sidecar stage | [ADR-0245](../adr/0288-session-scoped-vmcp-broker.md) |
| Independent per-backend connect, retry, and cancel; reconnect after permanent `Disconnect` | targeted ToolHive upstream controls | [ADR-0248](../adr/0291-bundled-mcp-workspace-enrollment.md) |
| Bootstrap-discovery CLI for generating curated static protected `tools:` | later operator tooling | [ADR-0248](../adr/0291-bundled-mcp-workspace-enrollment.md) |
| Required Kind/Helm qualification and browser ingress journey | optional deployment qualification / production deployment stage | [ADR-0246](../adr/0289-configured-resumable-mcp-authorization.md) |
| Production ingress, DNS, certificate, and Secret rotation qualification | production deployment stage | [ADR-0246](../adr/0289-configured-resumable-mcp-authorization.md) |
| Broad external-provider interoperability matrix | provider qualification stage | [ADR-0246](../adr/0289-configured-resumable-mcp-authorization.md) |
| ToolHive residual `httprc` goroutine remediation | upstream ToolHive | [ADR-0245](../adr/0288-session-scoped-vmcp-broker.md) |
| Another OAuth client/controller | excluded | [ADR-0245](../adr/0288-session-scoped-vmcp-broker.md) |
