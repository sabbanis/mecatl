...
instead of silently creating replacement authority. Durable/remote broker state and public
control lifecycle are later-stage work, not implied by the current callback mount.
