...
exactly-once effects, or HA ([ADR 0316](adr/0316-process-bound-remote-mcp-broker.md),
[ADR 0318](adr/0318-bounded-singleton-mcp-broker-correctness.md)).
...
NetworkPolicy provides no external hostname enforcement ([ADR 0317](adr/0317-single-replica-mcp-broker-topology.md)).
