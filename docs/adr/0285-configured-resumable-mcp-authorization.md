# ADR 0285 — Configured resumable MCP authorization
...
ADR 0284 established a root-internal ToolHive/vMCP Runtime with a fixed catalogue,
...
- [ADR 0284 — session-scoped vMCP broker](./0284-session-scoped-vmcp-broker.md)
