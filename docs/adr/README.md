...
- [0021 — Guardrails](./0021-guardrails.md) *(its one-payload/tool-less classifier architecture is drafted for supersession by 0334)*
- [0334 — Contextual investigative guardrails](./0334-contextual-investigative-guardrails.md) *(proposed; product direction approved, implementation calibration/measurement required, separately authorized real-model validation required before any production-readiness claim)*
