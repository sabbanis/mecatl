...
- [0350 — Mecatl Studio: in-repo web UI behind a BFF over the published SDK](./0350-mecatl-studio-in-repo-web-ui.md) *(proposed; `apps/` workspace, one-origin image, `MECATL_*`/`STUDIO_*` split)*
