...
- [0021 — Guardrails](./0021-guardrails.md) *(its one-payload/tool-less classifier architecture is drafted for supersession by 0350)*
- [0350 — Contextual investigative guardrails](./0350-contextual-investigative-guardrails.md) *(proposed; product direction approved, implementation calibration/measurement required, separately authorized real-model validation required before any production-readiness claim)*
