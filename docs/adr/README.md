...
- [0350 — Jev as an explicit delegated-model router backend](./0350-jev-delegated-model-router.md) *(proposed; narrowly supersedes ADR 0031's LLM-only classifier construction when selected)*
