...
- [0334 — Contextual investigative guardrails](./0334-contextual-investigative-guardrails.md) *(draft; product direction approved, real-checker quality gate unresolved)*
