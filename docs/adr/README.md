...
- [0057 — MCP server notifications](./0057-mcp-server-notifications.md) *(notification transport, bounded lazy-list, reconnect, and teardown decisions retained; 0345 supersedes only the deferred “no live catalog mutation” decision)*
