...
- [0326 — Persist saved mecatui gRPC server CA references](./0326-persisted-mecatui-server-ca.md) *(supersedes only ADR 0287's sole custom gRPC server-CA-input clause; all other ADR 0287 decisions remain authoritative)*
