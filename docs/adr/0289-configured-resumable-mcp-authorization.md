# ADR 0289 — Configured resumable MCP authorization
...
ADR 0288 established a root-internal ToolHive/vMCP Runtime with a fixed catalogue,
...
- [ADR 0288 — session-scoped vMCP broker](./0288-session-scoped-vmcp-broker.md)
