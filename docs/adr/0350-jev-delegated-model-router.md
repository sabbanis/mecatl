...
The linked acceptance plan records every material decision as directly approved in conversation. It remains `proposed` while Plan / Interface PR #1735 is under review; that approval is not a merged-plan approval. The user explicitly waived the merged-plan prerequisite for this stacked implementation.
