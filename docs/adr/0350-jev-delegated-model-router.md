...
The linked acceptance plan records direct conversational approval of this correction and scope. It remains `proposed` while Plan / Interface PR #1735 is open. Direct approval does not claim that PR merged. The earlier explicit waiver of the merged-plan prerequisite continues for stacked implementation PR #1738.
