...
|---|---|---|---|
| **Living truth** | `README.md`, `docs/architecture.md`, `docs/usage.md`, `docs/tui.md`, `docs/architecture/mecatl.modelith.md` (generated) | how the system works / is operated **now** | kept current; the single source for current behaviour |
