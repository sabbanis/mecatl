...
no pointer starts fresh ([ADR 0322](adr/0322-detached-runs.md)). `--new` forces a fresh
...
`mecated --detached-runs` (default OFF, [ADR 0322](adr/0322-detached-runs.md)) enables
...
[ADR 0322](adr/0322-detached-runs.md).

Detached runs are hardened (ADR 0322 decision 6, Scenario 5): they are **refused
