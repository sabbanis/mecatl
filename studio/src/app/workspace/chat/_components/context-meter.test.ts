...
/**
 * Pins the context-utilisation math the Agents panel's per-member meter
 * reads: occupancy over the window, clamped, and honestly null when the
 * window is unknown — a meter must never render against a made-up
 * denominator.
 */
