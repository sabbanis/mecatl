...
func TestADR_0228_AuthorityEvaluator_Scenario2_SetRoundTripsThroughSnapshotAndFold(t *testing.T) {
	t.Parallel()
...
func TestADR_0228_AuthorityEvaluator_Scenario2_PayloadExcludesSensitiveRuntimeData(t *testing.T) {
	t.Parallel()
	bound := authorityBinding(t)
...
func TestADR_0228_AuthorityEvaluator_Scenario2_UndecodableSetFailsClosedLoudly(t *testing.T) {
	t.Parallel()
...
func TestADR_0228_AuthorityEvaluator_Scenario2_NoSilentBoundButEmptyState(t *testing.T) {
	t.Parallel()
