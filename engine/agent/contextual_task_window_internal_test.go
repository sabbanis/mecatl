...
func TestADR_0350_ContextualGuardrails_TaskWindowUsesGenuineRootPrompts(t *testing.T) {
...
func TestADR_0350_ContextualGuardrails_TruncatedRootAuthorityIsIncomplete(t *testing.T) {
...
func TestADR_0350_ContextualGuardrails_PlanReceiptIsSeparatePositiveFact(t *testing.T) {
