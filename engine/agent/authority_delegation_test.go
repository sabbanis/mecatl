...
func TestADR_0228_AuthorityEvaluator_Scenario4_ChildGetsIntersectionOnEverySeam(t *testing.T) {
...
func TestADR_0228_AuthorityEvaluator_Scenario4_RefusalAcquiresNoRuntimeResource(t *testing.T) {
...
func TestADR_0228_AuthorityEvaluator_Scenario4_OnlyManagedTierSuppliesACeiling(t *testing.T) {
...
func TestADR_0228_AuthorityEvaluator_Scenario4_CallTighteningCannotWiden(t *testing.T) {
	parent := authorityParent()
	tooDeep := 3
	filesystem := true
	directWrite := true
...
func TestADR_0228_AuthorityEvaluator_Scenario4_OwnerAndSetAreIndependentlyStamped(t *testing.T) {
...
func TestADR_0228_AuthorityEvaluator_Scenario5_ResumedChildCannotExceedCurrentParent(t *testing.T) {
...
func TestADR_0228_AuthorityEvaluator_Scenario5_ResumeSpendsNoAdditionalHop(t *testing.T) {
...
func TestADR_0228_AuthorityEvaluator_Scenario5_NoWideningAcrossRestart(t *testing.T) {
	persisted := session.Authority{CapabilitySet: governance.CapabilitySet{Tools: []string{"Read"}, RemainingDelegationDepth: 0, FileSystem: true}, Provenance: "delegated", DefinitionIdentity: "root"}
	if err := validateResumedAuthority(authorityParent(), persisted, true); err != nil {
		t.Fatal(err)
	}
...
func TestADR_0228_AuthorityEvaluator_Scenario6_ComposedRootCanDelegateOnEverySeam(t *testing.T) {
