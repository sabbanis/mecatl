...
func TestADR_0228_AuthorityEvaluator_Scenario1_NarrowIsIntersectionOnEveryAxis(t *testing.T) {
	t.Parallel()
...
func TestADR_0228_AuthorityEvaluator_Scenario1_OperationsAreMonotone(t *testing.T) {
	t.Parallel()
...
func TestADR_0228_AuthorityEvaluator_Scenario1_DepthExhaustionIsAnError(t *testing.T) {
	t.Parallel()
...
func TestADR_0228_AuthorityEvaluator_Scenario1_SingleRepresentationAndSerializer(t *testing.T) {
	t.Parallel()
