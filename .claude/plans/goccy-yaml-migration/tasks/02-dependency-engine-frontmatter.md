...
Update root and engine module metadata/sums and parser-specific engine allowlist
entries as needed for this vertical slice. Do not migrate root configuration
adapters, settings editors, or lenient root readers here. Keep the engine
...
imports through tasks 03–05. Run focused engine adapter tests and
