...
|---|---|---|
| `01-project-domain-store-sources` | — | Foundation only; no AC is independently complete |
| `02-project-session-creation` | `01-project-domain-store-sources` | AC1.1–AC1.8 and AC2.1–AC2.6 (one combined ADR-0230 release) |
...
- ADR-0230 rollout correction and its combined captured-binding/Project-session release are owned by task 02; status promotion occurs only when that combined contract lands.
