...
- Direct-write/base-sharing children use the exact parent content backend and a fresh ledger; forked children use their fork content backend and a fresh ledger.
