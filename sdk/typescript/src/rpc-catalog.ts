...
const rpcCatalogRows = [
  ...
  rpc({
    key: "HarnessService.ListGuardrailCoverage",
    service: "HarnessService",
    method: "ListGuardrailCoverage",
    shape: "unary",
    backingService: "ListGuardrailCoverage",
    grpc: grpc(HarnessService.method.listGuardrailCoverage),
    http: grpcOnly("No HTTP route is defined for this guardrail RPC."),
  }),
  rpc({
    key: "HarnessService.GetGuardrailReviewDetail",
    service: "HarnessService",
  ...
  rpc({
    key: "HarnessService.ResolveRunAsk",
    service: "HarnessService",
    method: "ResolveRunAsk",
    shape: "unary",
    backingService: "ResolveRunAsk",
    grpc: grpc(HarnessService.method.resolveRunAsk),
    http: http(
      "POST",
  ...
  rpc({
    ...
    method: "CancelRun",
    shape: "unary",
    backingService: "CancelRun",
    grpc: grpc(HarnessService.method.cancelRun),
    http: http("POST", "/v1/sessions/{id}/controls/cancel", ["id=session_id"], [], "json", "json"),
  }),
  rpc({
    key: "HarnessService.SteerRun",
    service: "HarnessService",
    method: "SteerRun",
    shape: "unary",
    backingService: "SteerRun",
    grpc: grpc(HarnessService.method.steerRun),
    http: http("POST", "/v1/sessions/{id}/controls/steer", ["id=session_id"], [], "json", "json"),
  }),
  rpc({
    key: "HarnessService.CancelRunSteer",
    service: "HarnessService",
    method: "CancelRunSteer",
    shape: "unary",
    backingService: "CancelRunSteer",
    grpc: grpc(HarnessService.method.cancelRunSteer),
    http: http(
      "POST",
