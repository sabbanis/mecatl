...
test("packed tarball carries dist and license only", () => {
  ...
  const expectedFiles = [
    ...
    "package/dist/http-wkt.d.ts",
    "package/dist/http-wkt.d.ts.map",
    "package/dist/http-wkt.js",
    "package/dist/http-wkt.js.map",
    ...
    "package/dist/mcp-workspace-enrollment.js.map",
    ...
    "package/dist/run-controls.d.ts",
    "package/dist/run-controls.d.ts.map",
    "package/dist/run-controls.js",
    "package/dist/run-controls.js.map",
    ...
    "package/dist/spawn-common.js.map",
