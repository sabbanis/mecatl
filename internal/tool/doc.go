...
// the filesystem seams (FileSystem and Workspace) that every tool executes
// against.
//
// FileSystem and Workspace live here, not in internal/port. ARCHITECTURE.md §2
...
// is []tool.ToolSpec) and Tool.Execute takes a Workspace, so if Workspace lived
