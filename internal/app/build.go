...
type Config struct {
	...
	// DetachedRuns is the operator-tier detached-runs gate (ADR 0322,
	...
	// (ADR 0322 decision 6's concurrency gate; server.Config.MaxDetachedRuns).
	...
	// (ADR 0322 decision 6's "forgot to come back" deadline;
