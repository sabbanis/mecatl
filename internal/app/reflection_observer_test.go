...
func TestInvariant_learned_skill_partition_lifecycle_serialized(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "publishable activation", publishable: true, evaluation: learning.SkillEvaluation{Verdict: learning.EvaluationPass, FixtureIDs: []string{"fixture-pass"}}, wantState: learning.SkillActive},
