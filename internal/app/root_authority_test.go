...
func TestADR_0228_AuthorityEvaluator_Scenario6_MintPopulatesEveryFieldExplicitly(t *testing.T) {
...
func TestADR_0228_AuthorityEvaluator_Scenario6_PostureLineReportsEvaluator(t *testing.T) {
