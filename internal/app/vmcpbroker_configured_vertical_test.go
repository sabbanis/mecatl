...
func TestSessionMCPAuthorization_Scenario10_ConfigDrivenVertical(t *testing.T) {
	...
	configureScenario10SystemRoots(t, callbackServer.Certificate())
...
`), 0o600); err != nil {
	...
	provider := mockllm.New(
		mockllm.ToolCallTurn(session.NewToolCall(callID, "mcp__github__protected", json.RawMessage(`{}`))),
	...
	assertScenario10SafeEvents(t, parkedEvents, []string{secretCanary, tokenCanary, callbackServer.URL, fixture.gateway.URL})
	...
	assertScenario10SafeEvents(t, continuedEvents, []string{secretCanary, tokenCanary, "scenario10-code-canary", browserURL, callbackServer.URL, fixture.gateway.URL})
...
func newScenario10Fixture(t *testing.T, token string) *scenario10Fixture {
	...
	fixture.gateway = httptest.NewServer(mux)
	issuer := fixture.gateway.URL
