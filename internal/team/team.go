...
//
// It is a domain leaf: it imports only internal/session (for SessionID) and the
...
// the LLM — the supervisor (internal/agent) drives the running sessions and shares
