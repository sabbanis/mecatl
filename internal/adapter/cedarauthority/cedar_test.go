...
func TestADR_0228_AuthorityEvaluator_Scenario7_PolicyIsStaticAndDataIsPerRequest(t *testing.T) {
	t.Parallel()
...
func TestADR_0228_AuthorityEvaluator_Scenario7_OperatorRuleTightensButCannotGrant(t *testing.T) {
	t.Parallel()
...
func TestADR_0228_AuthorityEvaluator_Scenario7_CedarStaysOutOfTheEngineModule(t *testing.T) {
	t.Parallel()
