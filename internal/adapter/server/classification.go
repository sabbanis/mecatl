...
var serviceAccessTable = map[string]ClassificationEntry{
	...
	"DetachedRuns":            {KindSharedInfrastructure, "the operator-tier detached-runs toggle, identical for every caller; the Converse handler consults it to honour Prompt.detach"},
