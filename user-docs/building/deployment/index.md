...
| [Run `mecak8s`](./mecak8s.md) | Use Redis-backed sessions and Kubernetes Leases across disposable replicas, with the singleton MCP broker in the same Helm release. |
