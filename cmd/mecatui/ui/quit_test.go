...
func (errSession) CreateSession(_ context.Context, _ client.ModelSelection) (string, client.Capabilities, error) {
	return "", client.Capabilities{}, context.DeadlineExceeded
}
