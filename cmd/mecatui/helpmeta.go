...
var flagApplicabilityByFlag = map[string]flagApplicability{
	...
	"default-placement":    {group: groupSession, common: true, local: true, connect: false},
	"microvm-guest-egress": {group: groupSession, common: false, local: true, connect: false},
	"microvm-guest-allow":  {group: groupSession, common: false, local: true, connect: false},
