...
func EventToMsg(ev *mecatlv1.Event) tea.Msg {
	...
	case "permission.ask":
		return permissionAskMsg(ev.GetAsk())
...
func permissionAskMsg(a *mecatlv1.PermissionAsk) PermissionAskMsg {
	msg := PermissionAskMsg{AskID: a.GetAskId(), Tool: a.GetTool(), Args: a.GetArgs(), Reason: a.GetReason()}
